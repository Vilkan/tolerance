...
struct qt_meta_stringdata_SectorWidget_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SectorWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SectorWidget_t qt_meta_stringdata_SectorWidget = {
    {
QT_MOC_LITERAL(0, 0, 12) // "SectorWidget"
...
const QMetaObject SectorWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SectorWidget.data,
      qt_meta_data_SectorWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SectorWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SectorWidget.stringdata0))
