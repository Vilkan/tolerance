...
struct qt_meta_stringdata_GraphMapWidget_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GraphMapWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GraphMapWidget_t qt_meta_stringdata_GraphMapWidget = {
    {
QT_MOC_LITERAL(0, 0, 14) // "GraphMapWidget"
...
const QMetaObject GraphMapWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GraphMapWidget.data,
      qt_meta_data_GraphMapWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GraphMapWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GraphMapWidget.stringdata0))
