...
struct qt_meta_stringdata_UnitDialog_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UnitDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UnitDialog_t qt_meta_stringdata_UnitDialog = {
    {
QT_MOC_LITERAL(0, 0, 10) // "UnitDialog"
...
const QMetaObject UnitDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UnitDialog.data,
      qt_meta_data_UnitDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UnitDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UnitDialog.stringdata0))
